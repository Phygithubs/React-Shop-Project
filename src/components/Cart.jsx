...
function Card() {
  ...
  const products = [
    { name: "Camera", price: "123.00", image: "/image/product-1.jpg" },
    { name: "Blue Sweater", price: "99.99", image: "/image/product-2.jpg" },
    { name: "Lamp", price: "150.00", image: "/image/product-3.jpg" },
    { name: "Shoes", price: "89.99", image: "/image/product-4.jpg" },
    { name: "Watch", price: "299.00", image: "/image/product-5.jpg" },
    { name: "Headphones", price: "199.00", image: "/image/product-6.jpg" },
    { name: "Smartphone", price: "599.00", image: "/image/product-7.jpg" },
